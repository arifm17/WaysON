...
/**
 * Created by arifraqilla on 6/24/2015.
 */
public class ProfileActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        photo = (ImageView) findViewById(R.id.profile_pict);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        try {
            ...
            if (requestCode == RESULT_LOAD_IMG && resultCode == RESULT_OK
                ...
                cursor.close();
                ImageView imgView = (ImageView) findViewById(R.id.profile_pict);
    ...
    public void makeHTTPCall() {
        ...
        client.post("http://192.168.43.3/wayson/imgupload/upload_image.php",
