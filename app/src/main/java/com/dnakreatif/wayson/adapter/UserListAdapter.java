...
/**
 * Created by arifraqilla on 5/23/2015.
 */
public class UserListAdapter extends ArrayAdapter<DrawerItem> {

    Context context;
    List<DrawerItem> drawerItemList;
    int layoutResID;

    public UserListAdapter(Context context, int layoutResourceID,
